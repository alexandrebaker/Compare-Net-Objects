...
//Security restriction in Silverlight prevents getting private properties and fields
            ...
            string breadCrumb)
        {
            ...
            foreach (FieldInfo item in currentFields)
            {
                ...
                bool object1IsParent = objectValue1 != null && (objectValue1 == object1 || _parents.Contains(objectValue1.GetHashCode()));
                bool object2IsParent = objectValue2 != null && (objectValue2 == object2 || _parents.Contains(objectValue2.GetHashCode()));
